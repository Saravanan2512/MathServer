...
.box {
display:block;
border: Thick dashed rgb(227, 56, 4);
width: 500px;
min-height: 300px;
font-size: 20px;
...
<center><font color="orange"> SARAVANAN G<font></center>
<center>(212223230194) </center>
<form method="POST">
{% csrf_token %}
<div class="formelt">
...
![image](https://github.com/Saravanan2512/MathServer/assets/144979117/dc83e1db-1c61-4456-91c9-62d1e7c8e580)


## HOMEPAGE:
![image](https://github.com/Saravanan2512/MathServer/assets/144979117/d9e1dd76-b8a2-429a-9c5e-1f5b782d2f79)
